package com.liferay.headless.test.client.resource.v1_0;

import com.liferay.headless.test.client.dto.v1_0.Entity;
import com.liferay.headless.test.client.http.HttpInvoker;
import com.liferay.headless.test.client.pagination.Page;
import com.liferay.headless.test.client.problem.Problem;
import com.liferay.headless.test.client.serdes.v1_0.EntitySerDes;
...
public interface EntityResource {
	...
	public static class EntityResourceImpl implements EntityResource {
		...
		public HttpInvoker.HttpResponse getEntitiesPageHttpResponse()
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/headless-test/v1.0/entities");
		...
		public HttpInvoker.HttpResponse postEntityBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/headless-test/v1.0/entities/batch");
		...
		public HttpInvoker.HttpResponse deleteEntityHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-test/v1.0/entities/{entityId}");
